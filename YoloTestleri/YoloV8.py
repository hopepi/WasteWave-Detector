...
def main():
    ...
    model.train(
        ...
        workers=0,                  # Veriyi işlemek için kullanılacak CPU çekirdeği sayısı. Yüksek sayılar veri yüklemesini hızlandırabilir.
        optimizer="SGD",            # Optimizasyon algoritması. 'SGD' (Stochastic Gradient Descent) veya 'Adam' kullanılabilir.
        lr0=0.001,                  # Başlangıç öğrenme oranı. Daha küçük değerler daha yavaş ama sağlam öğrenme sağlar.
...
#       freeze=[0],                 # Belirtilen katmanları dondurur. İnce ayar (fine-tuning) sırasında kullanışlıdır.
    ...
    if results:
        ...
        print("Validation results are empty. Check your dataset or model configuration.")
